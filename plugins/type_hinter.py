...
def execute(params):
    ...
    has_typing_import = "from typing import" in hinted_code or "import typing" in hinted_code
    ...
    if needs_any and not has_typing_import:
        ...
        if "from typing import" in hinted_code:
            hinted_code = hinted_code.replace("from typing import ", "from typing import Any, ")
