...
PLUGIN_PARAMS = {"text": "text to translate", "source": "source language (auto for auto-detect)", "target": "target language (en, de, fr, es, etc.)"}
...
LANG_MAP = {
    ...
    "chinese": "zh", "japanese": "ja", "arabic": "ar", "turkish": "tr",
    "polish": "pl", "swedish": "sv", "korean": "ko",
}
